...
文件名后缀带有“py39”的为：只能运行在python版本环境为3.9.x的环境下。
文件名后缀带有“py311”的为：只能运行在python版本环境为3.11.x的环境下。
...
**1. 前提**
 ...
 - 下载脚本
 ```
 git clone https://github.com/honorcnboy/telegram_channel_downloader.git
 ```
